...
EnableSonars:
	...
	LOAD 	Mask0			; ENABLES SENSOR0
 	...
 	STORE	X
 	STORE	GRIDX			; STORE IT TO GRIDX
 	SHIFT 	-1				; DIVIDE IT BY 2
 	STORE	GRIDX			; STORE IT TO GRIDX

 	LOAD 	GRIDX			; (GRIDX-1)4+(GRIDY-1)
 	ADDI 	-1
 	SHIFT	2
 	ADD		GRIDY
 	ADDI	-1
 	...
 	;LOAD	A
 	ILOAD	ARRAYINDEX		; CHECKS IF THERE IS SOMETHING IN MAP AT THAT INDEX
 	SUB		One
 	;JUMP	ROTATE
 	JZERO	OCC
 	;JUMP	NOPE
...
NOPE:
	OUT 	BEEP			;
	LOAD   	FMid			; IF THERE IS NOTHING THERE IN THE MAP, MOVE FORWARD
	OUT    	LVELCMD     
	OUT		RVELCMD			
	JUMP	EnableSonars	;
