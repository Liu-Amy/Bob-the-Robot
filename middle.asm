...
SEARCH:
	...
	OUT    	LVELCMD     
	OUT    	RVELCMD	
	IN 		DIST0			; STORE THE VALUE OF DIST0 TO SENSOR0
	STORE	SENSOR0
	STORE	CURRENTSENSOR	; STORE DIST0 AS THE "SMALLEST" VALUE
	LOAD	NINTY			
	STORE 	CURRENTANGLE	; STORE THE ANGLE OF THE "SMALLEST" VALUE 
	LOAD	One				; OBJECT IS ON THE LEFT OF THE ROBOT
	STORE	LEFT			
