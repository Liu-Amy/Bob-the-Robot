...
GO4FEET:
	...
	IN		XPOS				; STORES THE X COORDINATE BEFORE RESET
	STORE	RESETX
	IN		YPOS				; STORES THE Y COORDINATE BEFORE RESET
	STORE	RESETY
	OUT		RESETPOS			; RESET
	JUMP	ROTATE				; IF YOU HAVE GONE 4 FEET, START ROTATION
	
ROTATE:
	IN		THETA				; DISPLAY THETA
	OUT		SSEG2
	
	LOAD	FMid				; ROTATE 90 DEGREES TO THE LEFT
	OUT		RVELCMD
	IN 		THETA 
	ADDI	-60
...
FORWARD:
	...
	JUMP	SEARCH0				; SEARCH FOR THINGS NEAR SONAR0
...
SEARCH0:
	...
	SUB		TWOFEET
	SUB		TWOFEET		
	JPOS	FORWARD				; IF THERE IS NOTHING 4 FEET AWAY, MORE FORWARD
	JNEG	FOUND0				; THERE IS SOMETHING CLOSE BY, STORE IT TO SENSOR0

FOUND0:				
	LOAD	TEMPDIST			; IT SENSES SOMETHING, GO TO FINDSMALL
	STORE	SENSOR0
	JUMP 	FINDSMALL0		

; SEARCH1:	
; 	IN 		DIST1				; STORE THE VALUE OF DIST1 TO SENSOR1
; 	STORE	TEMPDIST
; 	STORE	TEMPORARY
; 	SUB		TwoFeet				; IF MORE THAN 4 FEET AWAY, DO NOT STORE
; 	SUB		TwoFeet
; 	JPOS	SEARCH2
; 	LOAD 	TEMPDIST
; 	STORE	SENSOR1
; 	
; SEARCH2:	
; 	IN 		DIST2				; STORE THE VALUE OF DIST2 TO SENSOR2
; 	STORE	TEMPDIST
; 	STORE	TEMPORARY
; 	SUB		TwoFeet				;IF MORE THAN 4 FEET AWAY, DO NOT STORE
; 	SUB		TwoFeet
...
; 	
; SEARCH3:	
; 	IN 		DIST3				; STORE THE VALUE OF DIST3 TO SENSOR3
; 	STORE	TEMPDIST
; 	STORE	TEMPORARY
; 	SUB		TwoFeet				;IF MORE THAN 4 FEET AWAY, DO NOT STORE
; 	SUB		TwoFeet
...
; 
; SEARCH4:		
; 	IN 		DIST4				; STORE THE VALUE OF DIST4 TO SENSOR4
; 	STORE	TEMPDIST
; 	STORE 	TEMPORARY
; 	SUB		TwoFeet				; IF MORE THAN 4 FEET AWAY, DO NOT STORE
; 	SUB		TwoFeet
...
; 	
; SEARCH5:		
; 	IN 		DIST5				; STORE THE VALUE OF DIST5 TO SENSOR5 
; 	STORE	TEMPDIST
; 	STORE 	TEMPORARY
; 	SUB		TwoFeet				; IF MORE THAN 4 FEET AWAY, DO NOT STORE
; 	SUB		TwoFeet
...
; 	LOAD	CURRENTSENSOR		; IS SENSOR1 CLOSER THAN THE CURRENT SMALLEST?
; 	SUB		SENSOR1
; 	JPOS	CHOSE1
; 	
...
; 	JPOS	CHOSE2
; 	
; 	LOAD	CURRENTSENSOR		; IS SENSOR3 CLOSER THAN THE CURRENT SMALLEST?
; 	SUB		SENSOR3
; 	JPOS	CHOSE3
; 
; 	LOAD	CURRENTSENSOR		; IS SENSOR4 CLOSER THAN THE CURRENT SMALLEST?
; 	SUB		SENSOR4
; 	JPOS	CHOSE4
; 	
...
MOVETOWARDSOBJECT:				; MOVE FORWARD TOWARDS THE OBJECT
	...
	SUB		TEMPVAR				; DISTANCE TO CLOSEST OBJEC
	JNEG	MOVETOWARDSOBJECT	; IF ROBOT HAS NOT TRAVELED FAR ENOUGH, REPEAT
	LOAD	XPOS				
	STORE	GOHOMEX				; X POSITION OF ROBOT AFTER IT GOES UP THE MIDDLE
	LOAD	YPOS
	STORE	GOHOMEY				; Y POSITION OF ROBOT AFTER IT GOES UP THE MIDDLE
...
CALCHOMEDIST:					; CALCULATES THE DISTANCE FROM THE ROBOT TO HOMEBASE
	LOAD	RESETX				; L2Estimate = SQRT((RESETX-XPOS)^2+(RESETX-YPOS)^2)
	ADD		XPOS
	STORE	CALCX				; CALCX = L2X = RESETX-XPOS
	STORE	L2X
	LOAD	RESETY				; CALCY= L2Y = RESETY-YPOS
	ADD		YPOS
	STORE	CALCY
	STORE	L2Y
	CALL	L2Estimate			
...
CALCHOMEANGLE:		
	LOAD	CALCX				; HOMEANGLE = ARCTAN(CALCX/CALCY)
	STORE	AtanX 
	LOAD	CALCY
	STORE 	AtanY
	CALL	Atan2
...
HOMEROTATERIGHT:				; ROTATES CORRECT DEGREES TO THE RIGHT
	LOAD	FMid
	OUT 	LVELCMD
	IN 		THETA
	SUB		TEMPTHETA
...
GOHOME:
	...
	STORE 	TEMPHOME
	IN		XPOS			; L2X <- (XPOS-GOHOMEX) 
	SUB		GOHOMEX				
	STORE	L2X
	IN		YPOS			; L2Y <- (YPOS-GOHOMEY)
	SUB		GOHOMEY
	STORE	L2Y
	CALL	L2Estimate		; L2Estimate = SQRT((XPOS-X)^2+(YPOS-Y)^2)
	SUB		TEMPHOME			
...
CHOSE0:								; UPDATE INFORMATION OF THE CLOSEST OBJECT DETECTED
	LOAD	SENSOR0
	STORE	CURRENTSENSOR
	LOAD	NINTY
	STORE	CURRENTANGLE
...
; CHOSE1:
; 	LOAD	SENSOR1			; STORE SENSOR1 AS CLOSEST OBJECT AND 44 AS THE ANGLE
; 	STORE	CURRENTSENSOR
; 	LOAD	FOURTYFOUR
; 	STORE	CURRENTANGLE
; 	LOAD	One
...
; 	
; CHOSE2:
; 	LOAD	SENSOR2			; STORE SENSOR2 AS THE CLOSEST OBJECT AND 12 AS THE ANGLE
; 	STORE	CURRENTSENSOR
; 	LOAD	TWELVE
; 	STORE	CURRENTANGLE
; 	LOAD	One
...
; 	
; CHOSE3:	
; 	LOAD	SENSOR3			; STORE SENSOR3 AS THE CLOSEST OBJECT AND 12 AS THE ANGLE
; 	STORE	CURRENTSENSOR
; 	LOAD	NEGTWELVE
; 	STORE	CURRENTANGLE	
; 	LOAD	Zero
...
; 	
; CHOSE4:
; 	LOAD	SENSOR4			; STORE SENSOR4 AS THE CLOSEST OBJECT AND 44 AS THE ANGLE
; 	STORE	CURRENTSENSOR
; 	LOAD	NEGFOURTYFOUR
; 	STORE	CURRENTANGLE
; 	LOAD	Zero
...
; 	
; CHOSE5:
; 	LOAD	SENSOR5			; STORE SENSOR5 AS THE CLOSEST OBEJCT AND 90 AS THE ANGLE
; 	STORE	CURRENTSENSOR
; 	LOAD	NEGNINTY
; 	STORE	CURRENTANGLE
; 	LOAD	Zero
...
RESETX:			DW		0			; SAVES X BEFORE RESET
RESETY:			DW		0			; SAVES Y BEFORE RESET