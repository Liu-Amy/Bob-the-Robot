...
FORWARD:
	...
	LOAD	FMid				; GO FORWARD
; 	IN		XPOS				; IF XPOS IS OVER 12 FEET, RETURN HOME
; 	SUB		TWOFEET
; 	SUB		TWOFEET
; 	SUB		TWOFEET
; 	SUB		TWOFEET
...
FOUND0:							; IT SENSES SOMETHING, GO TO FINDSMALL
	LOAD	One
	STORE	FOUND
	LOAD	TEMPDIST			
	STORE	SENSOR0
...
FINDSMALL0:	
	...
	JPOS	CHOSE0				; IF SENSOR0 IS CLOSER THAN THE CLOSEST SENSOR, STORE SENSOR0 AS THE CLOSEST
 	JNEG	SEARCH2				; ELSE, IS THERE SOMETHING IN SENSOR5? (GUARANTEED TO HAVE A SMALL?)
...
SEARCH2:	
	...
	STORE	TEMPORARY
	LOAD	TEMPORARY
	SUB		TwoFeet				;IF MORE THAN 2 FEET AWAY, DO NOT STORE
	;SUB		TwoFeet
	JPOS	SEARCH3				; MOVE ON TO SEARCH FOR OBJECTS IN SENSOR5
	JNEG	FOUND2
	
FOUND2:				
	LOAD	One					; IT SENSES SOMETHING, GO TO FINDSMALL
	STORE	FOUND
	LOAD	TEMPDIST			
	STORE	SENSOR2
	LOAD	FFFF
...
SEARCH5:		
	IN 		DIST5				; STORE THE VALUE OF DIST0 TO SENSOR5, IF THERE IS SOMETHING 4 FEET AWAY 
	STORE	TEMPDIST
	STORE	TEMPORARY
	LOAD	TEMPORARY
	SUB		TWOFEET
	SUB		TWOFEET		
	JNEG	FOUND5				; FOUND SOMETHING IN SENSOR5
	
	LOAD	FOUND				; DID NOT FIND ANYTHING IN SENSOR5, BUT THERE WAS SOMETHING FOUND PREVIOUSLY
	JZERO	FORWARD
	JPOS	ROTATETOWARDSOBJECT

FOUND5:							; IT SENSES SOMETHING, GO TO FINDSMALL
	LOAD	One
	STORE	FOUND
	LOAD	TEMPDIST			
	STORE	SENSOR5
...
FINDSMALL5:
	...
	JNEG	ROTATETOWARDSOBJECT	; ELSE, ROTATE TOWARDS THE CLOSEST OBJECT. GUARANTEED TO HAVE ONE AT THIS POINT 
...
MOVETOWARDSOBJECT:				; MOVE FORWARD TOWARDS THE OBJECT
	...
	IN		THETA					
	STORE	TEMPTHETA			; STORE THE THETA AFTER ROTATING TOWARDS OBJECT
	JUMP	CALCHOMEANGLE		; THE ROBOT HAS ROTATED ENOUGH
	
CALCHOMEANGLE:		
	IN		XPOS				; HOMEANGLE = ARCTAN(CALCX/CALCY)
	STORE	AtanX 
	IN		YPOS
	STORE 	AtanY
	CALL	Atan2
...
HOMEROTATERIGHT:				; ROTATES CORRECT DEGREES TO THE RIGHT
	...
	IN		THETA				; ROTATE RIGHT UNTIL ROBOT FACES HOME
	SUB		CORRECTANGLE
