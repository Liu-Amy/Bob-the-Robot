...
SEARCH0:
	...
	SUB		TWOFEET
	SUB		TWOFEET		
	JPOS	SEARCH5				; IF THERE IS NOTHING 4 FEET AWAY, MORE FORWARD
...
FINDSMALL0:	
	...
	JNEG	SEARCH5				; ELSE, IS THERE SOMETHING IN SENSOR5? (GUARANTEED TO HAVE A SMALL?)
...
HOMEROTATERIGHT:				; ROTATES CORRECT DEGREES TO THE RIGHT
	...
	IN 		THETA				; RIGHTTHETA IS THE THE NORMALIZED THETA / ANGLED IT HAS ROTATED
	OUT		SSEG2
; 	STORE	RIGHTTHETA
; 	LOAD	RIGHTTHETA
; 	SUB		TEMPTHETA
